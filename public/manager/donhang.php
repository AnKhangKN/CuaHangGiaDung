    ...
    <div class="content__section">
        <div class="content__header">
            ...
            <div class="content__header-form">
                <form action="/CHDDTTHKN/assets/view/QuanLy/donhang.php" class="content__header-form-search">
                ...
                <form action="/CHDDTTHKN/assets/view/QuanLy/donhang.php" class="content__header-form-search-cost" method="GET">
            ...
            <div class="content__body">
                ...
                <?php include $_SERVER['DOCUMENT_ROOT'] . "/CHDDTTHKN/assets/controller/paginationDonHang.php" ?>
