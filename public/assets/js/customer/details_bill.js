$(document).ready(function () {
  ...
  function checkCustomerStatus(callback) {
    $.ajax({
      ...
      error: function (jqXHR, textStatus, errorThrown) {
        console.error(
          "Lỗi khi kiểm tra trạng thái khách hàng:",
          textStatus,
          errorThrown
        );
      },
  ...
  function getInfo(idKhachHang, containerRow) {
    ...
    $.ajax({
      type: "POST",
      url: "/CuaHangGiaDung/app/controllers/customer/get_product_comment.php",
      data: {
      ...
      error: function (jqXHR, textStatus, errorThrown) {
        console.error(
          "Lỗi khi gửi yêu cầu lấy bình luận:",
          textStatus,
          errorThrown
        );
      },
  ...
  function sendComment(idKhachHang) {
    ...
    $.ajax({
      type: "POST",
      url: "/CuaHangGiaDung/app/controllers/customer/send_comment.php",
      data: {
        action: "sendComment",
        productId: productId,
        billId: billId,
