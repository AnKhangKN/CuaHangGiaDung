...
<body>
  ...
  <div class="container_main">
    <nav class="nav">
      <ul class="list_tool">
        <li class="list_tool_item"><i class="fa-solid fa-bag-shopping"></i><a href="index.php?page=sanpham"> SẢN PHẨM</a></li>
        <li class="list_tool_item"> <i class="fa-regular fa-user"></i> <a href="index.php?page=khachhang">KHÁCH HÀNG</a></li>
        <li class="list_tool_item"><i class="fa-solid fa-chart-simple"></i><a href="index.php?page=thongke"> THỐNG KÊ</a></li>
        <li class="list_tool_item"><i class="fa-solid fa-check"></i><a href="index.php?page=duyetdon"> DUYỆT ĐƠN</a></li>
      </ul>
    </nav>