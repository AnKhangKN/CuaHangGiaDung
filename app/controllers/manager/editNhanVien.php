...
if (isset($_POST["product__sumit"])) {
    ...
    try {
        ...
        $stmt2 = $conn->prepare("UPDATE taikhoan SET email = ?, quyen = ? WHERE idTaiKhoan = ?");
        $stmt2->bind_param("sii", $email, $quyen, $idTaiKhoan);
        $stmt2->execute();
        ...
        $conn->rollback();
        echo "<script>
            alert('Không thể sửa nhân viên này: " . $e->getMessage() . "');
                ...
                <div class="content__header">
                    ...
                    <div class="content__body">
                        <div class="content__body-container">
                            <form action="/CHDDTTHKN/assets/controller/editNhanVien.php" class="content__modal-body-form" method="POST">
