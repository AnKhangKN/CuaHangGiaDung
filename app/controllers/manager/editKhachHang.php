...
if (isset($_POST["product__sumit"])) {
    ...
    try {
        ...
        $conn->rollback();
        echo "<script>
            alert('Không thể sửa thông tin khách hàng này.');
            window.location.href = '/CuaHangGiaDung/public/manager/index.php?page=khachhang';
            </script>";
    }
}
                ...
                <div class="content__header">
                    ...
                    <div class="content__body">
                        <div class="content__body-container">
                            <form action="/CuaHangGiaDung/app/controllers/manager/editKhachHang.php" class="content__modal-body-form" method="POST">
                        ...
                        <input type="email" name="email" id="" class="content__modal-body-input" value="<?php echo $row_kh_tk["email"] ?>" placeholder="Nhập email"> -->
                                ...
                                <input class="content__modal-body-submit" name="product__sumit" type="submit" value="Lưu khách hàng đã sửa">
                            </form>
                        </div>
